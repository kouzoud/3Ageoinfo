...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'CityAlert - Signalement d\'Incidents Urbains',
        short_name: 'CityAlert',
        description: 'Application de signalement d\'incidents urbains en temps réel',
        theme_color: '#1e3a8a',
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            // Stale While Revalidate pour les fichiers Leaflet (cartes)
